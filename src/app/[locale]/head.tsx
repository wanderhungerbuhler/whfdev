...
export default function Head() {
  ...
  const description =
    'Crie seu site, monte seu negócio com a melhor agência digital e design em criação de logo, sites, produção de vídeos, marketing digital e muito mais com a WHFDEV.'
  const pageImage = ''
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Crie seu site, monte seu negócio com a melhor agência digital
    e design em criação de logo, sites, produção de vídeos, marketing digital e muito mais com a WHFDEV."
      />

      <meta
        name="keywords"
        content="whfdev, whf, websites, desenvolvedor front-end,
      ...
      <meta
        ...
        content="Rua Joaquim Martins, nº 517"
      />
